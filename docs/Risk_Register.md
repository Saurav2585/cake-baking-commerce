...
| R-015 | A proposed retailer name conflicts with trademarks, company names, domains, handles or linguistic meaning. | H | H | Original shortlist rejected after collision screening. Treat revised names as provisional; require independent Indian legal/company, linguistic, domain and handle checks before production adoption. | PM + Brand | Open — blocks final name |
