...
| 1 — Discovery | UX Research, Catalog/Commerce | Phase 0 | Competitor/category evidence, audience hypotheses, jobs/journeys, terminology, catalog patterns, opportunity and constraint synthesis | Evidence is dated/cited; facts separated from inference; reference content not copied; research questions answered | Approve audience priority and research synthesis |
| 2 — Strategy & architecture | Brand Strategy, Catalog/Commerce, UX | Phase 1 | Positioning options, value proposition, voice principles, taxonomy, product/variant schema, commerce boundaries, sitemap and journey requirements | Options trace to research; catalog covers v1; future integrations have explicit interfaces | Approve brand direction, taxonomy, and commerce boundary |
| 3 — UX definition | UX/Product Design, Catalog/Commerce | Phase 2 | User flows, IA, wireframes, states, content model, recipe-to-cart rules | Critical journeys and edge states specified across breakpoints; accessibility needs annotated | Approve UX flows and wireframes |
